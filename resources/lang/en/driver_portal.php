...
return [
    ...
    'deliveries' => [
        ...
        'search_placeholder' => 'Search order #, DO, customer, phone, or address',
        'search_empty' => 'No deliveries match ":query".',
        ...
        'update_status_help' => 'When you arrive, upload a delivery photo and tap Delivered to confirm the handover.',
        'already_delivered' => 'This delivery has already been confirmed.',
        'delivered_no_proof' => 'This order is marked as :status. No delivery photo is on file — contact the office if you need to add one.',
        ...
        'record_payment_option' => 'Record Payment',
        'jump_items' => 'Order Items',
        'jump_payment' => 'Payment',
        'jump_delivery' => 'Delivery Status',
        'payment_gateway_coming_soon' => 'Online payment gateway coming soon. Customer can pay here when available.',
        'rm_scan_hint' => 'Show a QR code for the customer to scan and pay online.',
        'rm_collect_title' => 'Collect Payment',
        'rm_generating' => 'Generating secure QR code…',
        'rm_scan_to_pay' => 'Ask the customer to scan with any e-wallet',
        'rm_qr_alt' => 'Payment QR code',
        'rm_open_link' => 'Open payment link',
        'rm_ref' => 'Ref',
        'rm_waiting' => 'Waiting for payment…',
        'rm_received' => 'Payment received',
        'rm_refreshing' => 'Updating the order…',
        'rm_retry' => 'Try again',
        'rm_create_failed' => 'Could not start the payment. Please try again.',
        'rm_failed' => 'Payment failed or was cancelled. Please try again.',
        'rm_already_paid' => 'This order is already fully paid.',
        'rm_min_amount' => 'Amount too low for online payment (minimum RM :min).',
        'rm_payment_detail' => 'Payment for order :id',
        ...
        'hold_button' => 'Put On Hold (Unpaid)',
        'hold_hint' => 'Use this when the customer has not paid yet. The order stays with you until payment is settled.',
        'hold_success' => 'Order put on hold — waiting for payment.',
        'hold_requires_in_route' => 'Only an in-route order can be put on hold.',
        'on_hold_notice' => 'On hold — the customer has not paid yet. Collect payment, then resume the delivery.',
        'resume_button' => 'Resume Delivery',
        'resume_success' => 'Delivery resumed. You can now mark it delivered.',
        'resume_not_allowed' => 'This order is not on hold.',
        'expected_payment' => 'Customer plans to pay: :method (reference only)',
        'planned_payment' => 'Planned payment on delivery',
