...
return [
    ...
    'deliveries' => [
        ...
        'hold_button' => 'Deliver — Payment On Hold',
        'hold_hint' => "Customer hasn't paid yet. Hand over the goods and flag the payment on hold — record it once collected.",
        'hold_success' => 'Delivered — payment on hold. Record the payment once collected.',
        'hold_requires_in_route' => 'Only an unpaid, in-route COD order can be delivered with payment on hold.',
        'on_hold_notice' => 'Payment on hold — the customer has not paid yet. Record the payment once collected.',
