...
return [
    ...
    'deliveries' => [
        ...
        'hold_button' => '暂缓（未付款）',
        'hold_hint' => '当客户尚未付款时使用。订单将保留在您手中，直至完成付款。',
        'hold_success' => '订单已暂缓——等待付款。',
        'hold_requires_in_route' => '只有配送中的订单才能暂缓。',
        'on_hold_notice' => '已暂缓——客户尚未付款。收款后再继续配送。',
        'resume_button' => '继续配送',
        'resume_success' => '已继续配送，现在可以标记为已送达。',
        'resume_not_allowed' => '此订单未处于暂缓状态。',
        'expected_payment' => '客户计划付款方式：:method（仅供参考）',
        'planned_payment' => '计划货到付款方式',
