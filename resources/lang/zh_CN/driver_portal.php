...
return [
    ...
    'deliveries' => [
        ...
        'hold_button' => '送达——付款暂缓',
        'hold_hint' => '客户尚未付款时使用。交付货物并将付款标记为暂缓——收款后再记录。',
        'hold_success' => '已送达——付款暂缓。收款后请记录付款。',
        'hold_requires_in_route' => '只有配送中、未付款的货到付款订单才能以付款暂缓方式送达。',
        'on_hold_notice' => '付款暂缓——客户尚未付款。收款后请记录付款。',
