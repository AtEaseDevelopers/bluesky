                    ...
                    <form method="POST" action="{{ route('member.add-to-cart', encrypt($product->id)) }}" enctype="multipart/form-data" class="form-wrapper">
                        ...
                        @if ($product->sell_in == 'qty')
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ $product->added_to_cart? $product->added_to_cart->quantity : 1 }}" min="1" step="1">
                                @error('quantity')
                                    <span class="text-danger" role="alert">
                        ...
                        @elseif ($product->sell_in == 'qty_bill_weight')
                            <div class="mb-4">
                                ...
                                <span class="text-danger"> *</span>
                                <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity', $product->added_to_cart? $product->added_to_cart->quantity : 1) }}" min="1" step="1" required>
                                @error('quantity')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
