...
@if ($product->sell_in == 'qty')
    <div class="mb-4">
        ...
        <div class="btn-group w-100" role="group">
            ...
            <input type="number" class="form-control px-4" id="quantity" name="quantity" value="1" min="1" step="1">
...
@elseif ($product->sell_in == 'qty_bill_weight')
    <div class="mb-4">
        ...
        <div class="btn-group w-100" role="group">
            ...
            <input type="number" class="form-control px-4" id="quantity" name="quantity" value="{{ old('quantity', 1) }}" min="1" step="1" required>
            <button type="button" class="btn btn-outline-primary btn-plus">
                <i class="fa fa-plus" aria-hidden="true"></i>
            </button>
        </div>
