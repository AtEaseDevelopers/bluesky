...
@section('css')
    <style>
        @media (max-width: 767.98px) {
            #review-items-table tfoot td.review-tfoot-input {
                min-width: 9rem;
                width: 38%;
            }

            #review-items-table tfoot td.review-tfoot-input .form-control {
                min-width: 8rem;
                width: 100%;
                min-height: 44px;
                font-size: 1rem;
                            ...
                            <table class="table table-bordered" id="review-items-table">
                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        ...
                                        <tr class="review-line" data-unit-price="{{ $product->unit_price }}" data-sell-in="{{ $sellIn }}">
                                            ...
                                            <td>
                                                @if ($needsQty)
                                                    <input type="number" step="1" min="1" class="form-control line-qty"
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="review-tfoot-input">
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end"><strong>{{ __('orders.amount_adjustment') }}</strong></td>
                                        <td colspan="2" class="review-tfoot-input">
                                            @if ($canAdjustAmount)
