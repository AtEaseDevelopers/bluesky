                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="form-wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex gap-4">
                                <div class="mb-4">
                                    <input name="show_weight" id="show_weight" type="checkbox"/>
                                    <label class="mb-2" for="show_weight">Show Weight In Report</label>
                                </div>
                                <div class="mb-4">
                                    <input name="show_qty" id="show_qty" type="checkbox"/>
                                            ...
                                            <tbody>
                                                @foreach ($customer_categories as $category)
                                                    <tr>
                                                        ...
                                                        <td>{{ $category }}</td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" class="form-control" name="category_prices[{{ $category }}]" placeholder="Leave empty for default price" value="{{ old('category_prices.' . $category) }}">
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
