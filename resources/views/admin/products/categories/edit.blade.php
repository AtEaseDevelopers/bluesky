                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" id="code" placeholder="{{ __('product.categories.placeholder.code') }}" value="{{ old('code', $category->code) }}" maxlength="10">
                                    @error('code')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
