    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                ...
                Route::post('/customers/bulk-delete', 'CustomerController@bulkDelete')->name('customers.bulk-delete');
                ...
                Route::post('/order/{order}/shipping-address', 'OrderController@updateShippingAddress')->name('orders.shipping-address');
